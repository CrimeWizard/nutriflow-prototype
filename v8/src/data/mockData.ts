...
export const restaurants: Restaurant[] = [
  {
    ...
    meals: [
      ...
      { id: 'gb-6', name: 'Mediterranean Salad', description: 'Feta, olives, grilled chicken, lemon dressing', price: 155, protein: 28, calories: 340, image: '🥗', tags: ['lunch', 'low-carb'] },
    ],
  },
  {
    id: 'rest-fresh-wave',
    ...
    meals: [
      ...
      { id: 'fw-4', name: 'Spicy Tuna Bowl', description: 'Brown rice, seared tuna, edamame, chili oil', price: 225, protein: 34, calories: 400, image: '🍣', tags: ['high-protein', 'lunch'] },
    ],
  },
  {
    id: 'rest-fit-kitchen',
    ...
    meals: [
      ...
      { id: 'fk-4', name: 'Post-Gym Smoothie', description: 'Whey, oats, banana, peanut butter', price: 95, protein: 32, calories: 340, image: '🥤', tags: ['post-workout', 'snack'] },
    ],
  },
  {
    id: 'rest-lean-clean',
    ...
    meals: [
      ...
      { id: 'lc-5', name: 'Chicken & Rice Box', description: 'Grilled chicken, jasmine rice, roasted broccoli', price: 158, protein: 38, calories: 410, image: '🍗', tags: ['high-protein', 'meal-prep'] },
    ],
  },
  {
    id: 'rest-nourish',
    ...
    meals: [
      ...
      { id: 'nl-4', name: 'Falafel Wrap', description: 'Whole wheat wrap, falafel, tahini, pickles', price: 115, protein: 16, calories: 390, image: '🌯', tags: ['lunch', 'vegetarian'] },
    ],
  },
  {
    id: 'rest-protein-hub',
    name: 'Protein Hub',
    area: 'Nasr City',
    cuisine: 'Grilled & bowls',
    deliveryMins: '30–40 min',
    rating: 4.6,
    tags: ['high-protein', 'gym-friendly'],
    image: '🍗',
    meals: [
      { id: 'ph-1', name: 'Double Chicken Bowl', description: '200g chicken, rice, roasted veg, hot sauce', price: 168, protein: 46, calories: 450, image: '🍗', tags: ['post-workout', 'high-protein'] },
      { id: 'ph-2', name: 'Lean Steak Plate', description: '150g steak, sweet potato mash, side salad', price: 210, protein: 38, calories: 420, image: '🥩', tags: ['high-protein', 'dinner'] },
      { id: 'ph-3', name: 'Beef & Rice Box', description: 'Lean beef strips, brown rice, peppers', price: 178, protein: 34, calories: 440, image: '🥩', tags: ['meal-prep', 'lunch'] },
      { id: 'ph-4', name: 'Morning Egg Plate', description: '3 eggs, labneh, cucumber, whole wheat toast', price: 98, protein: 22, calories: 300, image: '🥚', tags: ['breakfast'] },
    ],
  },
  {
    id: 'rest-cairo-bowls',
    name: 'Cairo Bowls',
    area: 'Maadi',
    cuisine: 'Bowls & seafood',
    deliveryMins: '35–45 min',
    rating: 4.5,
    tags: ['seafood', 'high-protein'],
    image: '🍱',
    meals: [
      { id: 'cb-1', name: 'Salmon Poke Bowl', description: 'Quinoa, salmon, avocado, sesame', price: 235, protein: 36, calories: 430, image: '🐟', tags: ['high-protein', 'lunch'] },
      { id: 'cb-2', name: 'Teriyaki Salmon', description: 'Grilled salmon, jasmine rice, greens', price: 250, protein: 34, calories: 410, image: '🐟', tags: ['dinner', 'omega-3'] },
      { id: 'cb-3', name: 'Rainbow Veg Bowl', description: 'Roasted veg, chickpeas, tahini, quinoa', price: 130, protein: 18, calories: 370, image: '🥗', tags: ['vegetarian', 'lunch'] },
    ],
  },
  {
    id: 'rest-power-prep',
    ...
    image: '📦',
    meals: [
      { id: 'pp-1', name: 'Weekly Prep (5 meals)', description: 'Rotating high-protein meals, 5 containers', price: 680, protein: 38, calories: 440, image: '📦', tags: ['meal-prep'] },
      { id: 'pp-2', name: 'Chicken Meal Prep', description: 'Grilled chicken, rice, broccoli × 3 portions', price: 420, protein: 42, calories: 430, image: '🍗', tags: ['meal-prep', 'high-protein'] },
      { id: 'pp-3', name: 'Beef & Rice Prep', description: 'Lean beef, brown rice, peppers × 3 portions', price: 445, protein: 36, calories: 450, image: '🥩', tags: ['meal-prep'] },
    ],
  },
  {
    id: 'rest-grill-co',
    name: 'The Grill Co.',
    area: 'Heliopolis',
    cuisine: 'Grilled proteins',
    deliveryMins: '35–45 min',
    rating: 4.3,
    tags: ['high-protein', 'gym-friendly'],
    image: '🔥',
    meals: [
      { id: 'gc-1', name: 'Ribeye & Veg', description: 'Trimmed ribeye, grilled zucchini, side salad', price: 265, protein: 42, calories: 480, image: '🥩', tags: ['dinner', 'high-protein'] },
      { id: 'gc-2', name: 'Chicken Skewers', description: '3 skewers, rice pilaf, garlic yogurt', price: 155, protein: 36, calories: 390, image: '🍗', tags: ['lunch', 'high-protein'] },
      { id: 'gc-3', name: 'Grilled Chicken Salad', description: 'Mixed greens, grilled chicken, balsamic', price: 142, protein: 32, calories: 310, image: '🥗', tags: ['lunch', 'low-carb'] },
    ],
  },
];
...
export const shopProducts: ShopProduct[] = [
  ...
  { id: 'cf-9', supermarketId: 'sm-carrefour', name: 'Fresh Milk', brand: 'Juhayna', category: 'Dairy', price: 26, size: '1 L', image: '🥛' },
  { id: 'cf-10', supermarketId: 'sm-carrefour', name: 'Bananas', brand: 'Fresh', category: 'Produce', price: 18, size: '1 kg', image: '🍌' },
  { id: 'cf-11', supermarketId: 'sm-carrefour', name: 'Tomatoes', brand: 'Fresh', category: 'Produce', price: 12, size: '1 kg', image: '🍅' },
  { id: 'cf-12', supermarketId: 'sm-carrefour', name: 'Tuna in Water', brand: 'Goody', category: 'Pantry', price: 32, size: '185g', image: '🐟' },
  { id: 'cf-13', supermarketId: 'sm-carrefour', name: 'Lentils', brand: 'Al Doha', category: 'Grains', price: 28, size: '500g', image: '🫘' },
  { id: 'cf-14', supermarketId: 'sm-carrefour', name: 'Honey', brand: 'Imtenan', category: 'Pantry', price: 55, size: '500g', image: '🍯' },
  // Spinneys
  ...
  { id: 'sp-7', supermarketId: 'sm-spinneys', name: 'Chicken Breast', brand: 'Americana', category: 'Meat', price: 102, size: '½ kg', image: '🍗' },
  { id: 'sp-8', supermarketId: 'sm-spinneys', name: 'Labneh', brand: 'Juhayna', category: 'Dairy', price: 24, size: '400g', image: '🥛' },
  { id: 'sp-9', supermarketId: 'sm-spinneys', name: 'Brown Rice', brand: "Uncle Ben's", category: 'Grains', price: 72, size: '1 kg', image: '🍚' },
  { id: 'sp-10', supermarketId: 'sm-spinneys', name: 'Avocado', brand: 'Fresh', category: 'Produce', price: 28, size: '1 pc', image: '🥑' },
  { id: 'sp-11', supermarketId: 'sm-spinneys', name: 'Olive Oil', brand: 'Crystal', category: 'Pantry', price: 98, size: '750ml', image: '🫒' },
  { id: 'sp-12', supermarketId: 'sm-spinneys', name: 'Oats', brand: 'Quaker', category: 'Grains', price: 52, size: '500g', image: '🥣' },
  // Metro Market
  ...
  { id: 'mt-7', supermarketId: 'sm-metro', name: 'Oats', brand: 'Quaker', category: 'Grains', price: 46, size: '500g', image: '🥣' },
  { id: 'mt-8', supermarketId: 'sm-metro', name: 'Avocado', brand: 'Fresh', category: 'Produce', price: 24, size: '1 pc', image: '🥑' },
  { id: 'mt-9', supermarketId: 'sm-metro', name: 'Greek Yogurt 0%', brand: 'Almarai', category: 'Dairy', price: 40, size: '500g', image: '🥛' },
  { id: 'mt-10', supermarketId: 'sm-metro', name: 'Tomatoes', brand: 'Fresh', category: 'Produce', price: 11, size: '1 kg', image: '🍅' },
  { id: 'mt-11', supermarketId: 'sm-metro', name: 'Honey', brand: 'Imtenan', category: 'Pantry', price: 52, size: '500g', image: '🍯' },
  { id: 'mt-12', supermarketId: 'sm-metro', name: 'Fresh Milk', brand: 'Juhayna', category: 'Dairy', price: 25, size: '1 L', image: '🥛' },
  // Seoudi
  ...
  { id: 'sd-7', supermarketId: 'sm-seoudi', name: 'Brown Rice', brand: "Uncle Ben's", category: 'Grains', price: 66, size: '1 kg', image: '🍚' },
  { id: 'sd-8', supermarketId: 'sm-seoudi', name: 'Ground Beef 5%', brand: 'Americana', category: 'Meat', price: 112, size: '500g', image: '🥩' },
  { id: 'sd-9', supermarketId: 'sm-seoudi', name: 'Oats', brand: 'Quaker', category: 'Grains', price: 47, size: '500g', image: '🥣' },
  { id: 'sd-10', supermarketId: 'sm-seoudi', name: 'White Eggs', brand: 'El Wadi', category: 'Dairy', price: 60, size: '15 pack', image: '🥚' },
  { id: 'sd-11', supermarketId: 'sm-seoudi', name: 'Olive Oil', brand: 'Crystal', category: 'Pantry', price: 92, size: '750ml', image: '🫒' },
  { id: 'sd-12', supermarketId: 'sm-seoudi', name: 'Avocado', brand: 'Fresh', category: 'Produce', price: 23, size: '1 pc', image: '🥑' },
];
