import type {
  MealSuggestion, ProductCategory, Recipe, Restaurant, ShopProduct, Supermarket,
} from '../types';
...
export const todayMeals: MealSuggestion[] = [
  {
    time: '07:30', label: 'Breakfast', title: 'Protein Pancakes', type: 'meal',
    source: 'restaurant', restaurantId: 'rest-fit-kitchen', mealId: 'fk-1',
  },
  {
    time: '13:00', label: 'Lunch', title: 'Grilled Chicken Bowl', type: 'meal',
    source: 'restaurant', restaurantId: 'rest-green-bite', mealId: 'gb-1',
  },
  {
  ...
  {
    time: '19:30', label: 'Dinner', title: 'Chicken Rice Bowl', type: 'post-workout',
    source: 'recipe', recipeId: 'r1',
  },
];
