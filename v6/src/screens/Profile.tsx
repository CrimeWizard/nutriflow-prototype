import { ChevronRight, Dumbbell, Target, User } from 'lucide-react';
import { BUDGET_TIERS, DELIVERY_AREAS, GOALS, SHOPPING_MODES } from '../data/mockData';
import { useApp } from '../context/AppContext';
import { goalLabel, WEEK_ORDER } from '../utils';

export function Profile() {
  const { profile, setProfile, orderHistory, resetOnboarding, setScreen } = useApp();
