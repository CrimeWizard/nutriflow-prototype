import {
  ChevronRight, Dumbbell, Package, ShoppingBasket, Store, Utensils, UtensilsCrossed, Zap,
} from 'lucide-react';
...
export function Home() {
  const {
    ...
    orderHistory, setScreen,
  } = useApp();

  const activeOrders = orderHistory.filter((o) => isActiveOrder(o.placedAt));
